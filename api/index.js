...
const SESSION_COOKIE = "sessionid=80847931785%3AjScyZk3YCvh1Vu%3A24%3AAYjmE9deGYtO-npxcjuVYy1DUPITo6f3GvFue3tWAQ;";
const IG_USER_AGENT =
  "Instagram 155.0.0.37.107 (iPhone11,8; iOS 14_4; en_US; en-US; scale=2.00; 828x1792; 190542906)";

// tunnel.httpsOverHttp is the reliable way to do HTTPS-over-HTTP-proxy in Node
const httpsAgent = tunnel.httpsOverHttp({
  proxy: {
    host: "p105.instantproxies.com",
    port: 9204,
    proxyAuth: "5943:0lrWi9UthDVc",
  },
});
...
<body>
  ...
  <ul>
    ...
    <li><code>GET /posts?username=</code> — Latest 25 posts with full details</li>
